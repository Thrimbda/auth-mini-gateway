...
- [ ] Complete PR lifecycle and workspace cleanup. | 验收: PR reaches an explicit terminal state and worktree/main workspace are cleaned and refreshed. ← CURRENT
---
